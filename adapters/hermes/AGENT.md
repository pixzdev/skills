# hermes Adapter — PIXZ Universal Skills

> Thin translation of universal core into hermes conventions. No methodology fork.
...
- **hermes path:** see README compatibility table.
- **Registry:** always `AGENTS.md` + `registry.json` (validated by schemas/registry.schema.json)
- **Verification:** run `python scripts/resolve.py --runtime hermes --install pixz.core.orchestrator`
