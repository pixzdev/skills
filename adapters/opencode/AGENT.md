# opencode Adapter — PIXZ Universal Skills

> Thin translation of universal core into opencode conventions. No methodology fork.
...
- **opencode path:** see README compatibility table.
- **Registry:** always `AGENTS.md` + `registry.json` (validated by schemas/registry.schema.json)
- **Verification:** run `python scripts/resolve.py --runtime opencode --install pixz.core.orchestrator`
